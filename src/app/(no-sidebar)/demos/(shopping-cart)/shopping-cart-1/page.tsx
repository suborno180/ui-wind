                ...
                <div className="md:col-span-2 bg-gray-100 p-4 rounded-md">
                    ...
                    <div className="space-y-4">
                        <div className="grid grid-cols-3 items-center gap-4">
                            <div className="col-span-2 flex items-center gap-4">
                                <div className="w-24 h-24 shrink-0 bg-white p-2 rounded-md">
                                    <img src='https://readymadeui.com/images/product14.webp' alt='image' className="w-full h-full object-contain" />
                                </div>
                        ...
                        <div className="grid grid-cols-3 items-center gap-4">
                            <div className="col-span-2 flex items-center gap-4">
                                <div className="w-24 h-24 shrink-0 bg-white p-2 rounded-md">
                                    <img src='https://readymadeui.com/images/watch5.webp' alt='image' className="w-full h-full object-contain" />
                                </div>
                        ...
                        <div className="grid grid-cols-3 items-center gap-4">
                            <div className="col-span-2 flex items-center gap-4">
                                <div className="w-24 h-24 shrink-0 bg-white p-2 rounded-md">
                                    <img src='https://readymadeui.com/images/sunglass1.webp' alt='image' className="w-full h-full object-contain" />
                                </div>
