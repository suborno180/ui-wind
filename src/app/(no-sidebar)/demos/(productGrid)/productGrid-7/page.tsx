        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <div className="bg-gray-200 rounded-xl cursor-pointer hover:scale-[1.03] transition-all relative overflow-hidden">
            ...
            <div className="text-center bg-gray-100 p-6">
              ...
              <h4 className="text-lg text-gray-800 font-bold mt-6">
                $10 <del className="text-gray-400 ml-2 font-medium">$15</del>
              </h4>
          ...
          <div className="bg-gray-200 rounded-xl cursor-pointer hover:scale-[1.03] transition-all relative overflow-hidden">
            ...
            <div className="text-center bg-gray-100 p-6">
              ...
              <h4 className="text-lg text-gray-800 font-bold mt-6">
                $12 <del className="text-gray-400 ml-2 font-medium">$17</del>
              </h4>
          ...
          <div className="bg-gray-200 rounded-xl cursor-pointer hover:scale-[1.03] transition-all relative overflow-hidden">
            ...
            <div className="text-center bg-gray-100 p-6">
              ...
              <h4 className="text-lg text-gray-800 font-bold mt-6">
                $14 <del className="text-gray-400 ml-2 font-medium">$19</del>
              </h4>
              <button
                type="button"
                className="w-full flex items-center justify-center gap-3 mt-6 px-6 py-3 bg-yellow-400 text-base text-gray-800 font-semibold rounded-xl"
          ...
          <div className="bg-gray-200 rounded-xl cursor-pointer hover:scale-[1.03] transition-all relative overflow-hidden">
            ...
            <div className="text-center bg-gray-100 p-6">
              ...
              <h4 className="text-lg text-gray-800 font-bold mt-6">
                $15 <del className="text-gray-400 ml-2 font-medium">$20</del>
              </h4>
              <button
                type="button"
                className="w-full flex items-center justify-center gap-3 mt-6 px-6 py-3 bg-yellow-400 text-base text-gray-800 font-semibold rounded-xl"
          ...
          <div className="bg-gray-200 rounded-xl cursor-pointer hover:scale-[1.03] transition-all relative overflow-hidden">
            ...
            <div className="text-center bg-gray-100 p-6">
              ...
              <h4 className="text-lg text-gray-800 font-bold mt-6">
                $11 <del className="text-gray-400 ml-2 font-medium">$16</del>
              </h4>
              <button
                type="button"
                className="w-full flex items-center justify-center gap-3 mt-6 px-6 py-3 bg-yellow-400 text-base text-gray-800 font-semibold rounded-xl"
          ...
          <div className="bg-gray-200 rounded-xl cursor-pointer hover:scale-[1.03] transition-all relative overflow-hidden">
            ...
            <div className="text-center bg-gray-100 p-6">
              ...
              <h4 className="text-lg text-gray-800 font-bold mt-6">
                $13 <del className="text-gray-400 ml-2 font-medium">$18</del>
              </h4>
              <button
                type="button"
                className="w-full flex items-center justify-center gap-3 mt-6 px-6 py-3 bg-yellow-400 text-base text-gray-800 font-semibold rounded-xl"
