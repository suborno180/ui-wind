    ...
    <>
      <div className="bg-white py-6 sm:py-8 lg:py-12">
        <div className="mx-auto max-w-screen-2xl px-4 md:px-8">
          ...
          <section className="flex flex-col items-center justify-between gap-10 border-t border-gray-300 pt-8 lg:flex-row lg:gap-8">
            {/* <!-- stats - start --> */}
            <div className="-mx-6 grid grid-cols-2 gap-4 md:-mx-8 md:flex md:divide-x divide-gray-300">
