    ...
    <>
      <div className="bg-white lg:pb-12">
        <div className="mx-auto max-w-screen-2xl px-4 md:px-8">
          ...
          {/* <!-- menu - start --> */}
          <div className="hidden w-full overflow-hidden rounded-lg border border-gray-300 bg-gray-50 shadow-sm lg:block">
            <div className="mx-auto flex max-w-screen-lg items-center gap-8 p-8">
              ...
              {/* <!-- promo - start --> */}
              <div className="w-1/3 overflow-hidden rounded-lg border border-gray-300">
                ...
                <div className="flex items-center justify-between gap-2 bg-white p-3">
                  ...
                  <a
                    href="#"
                    className="inline-block shrink-0 rounded-lg border border-gray-300 bg-white px-3 py-1 text-sm font-semibold text-indigo-500 outline-none ring-indigo-300 transition duration-100 hover:bg-gray-50 focus-visible:ring active:bg-gray-100"
                  >
                    More
                  </a>
                </div>
