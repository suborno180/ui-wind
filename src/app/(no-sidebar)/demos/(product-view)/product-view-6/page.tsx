            ...
            <div className="max-lg:max-w-2xl">
              ...
              <div className="mt-8">
                ...
                <div className="flex flex-wrap gap-2 mt-4">
                  ...
                  <button
                    type="button"
                    className="w-10 h-10 bg-gray-400 border border-white hover:border-orange-500 rounded-full shrink-0"
                  ></button>
                  <button
                    type="button"
                    className="w-10 h-10 bg-orange-400 border border-white hover:border-orange-500 rounded-full shrink-0"
                  ></button>
                  <button
                    type="button"
                    className="w-10 h-10 bg-red-400 border border-white hover:border-orange-500 rounded-full shrink-0"
                  ></button>
                </div>
              </div>
              ...
              <div className="mt-8">
                ...
                <div className="flex flex-wrap gap-2 mt-4">
                  <button
                    type="button"
                    className="w-10 h-10 border hover:border-orange-500 font-semibold text-gray-800 text-sm rounded-full flex items-center justify-center shrink-0"
                  >
                    SM
                  </button>
                  <button
                    type="button"
                    className="w-10 h-10 border hover:border-orange-500 border-orange-500 font-semibold text-gray-800 text-sm rounded-full flex items-center justify-center shrink-0"
                  >
                    MD
                  </button>
                  <button
