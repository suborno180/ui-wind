                ...
                <div className="grid items-start grid-cols-1 lg:grid-cols-2 gap-8 max-lg:gap-16">
                    <div className="w-full lg:sticky top-0 text-center">
                        ...
                        <div className="flex flex-wrap gap-4 justify-center mx-auto mt-4">
                            <img src="https://readymadeui.com/images/product6.webp" alt="Product1" className="w-16 cursor-pointer rounded-md outline" />
                            <img src="https://readymadeui.com/images/product8.webp" alt="Product2" className="w-16 cursor-pointer rounded-md" />
                            <img src="https://readymadeui.com/images/product5.webp" alt="Product3" className="w-16 cursor-pointer rounded-md" />
                            <img src="https://readymadeui.com/images/product7.webp" alt="Product4" className="w-16 cursor-pointer rounded-md" />
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div className="flex flex-wrap gap-4 items-start">
                            <div>
                                ...
                                <p className="text-gray-500 text-sm mt-2"><del>$42</del> <span className="text-sm ml-1">Tax included</span></p>
                            </div>
