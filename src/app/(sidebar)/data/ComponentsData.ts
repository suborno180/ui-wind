...
`,
  ...
  },
  {
    ...
    items: [
      {
        id: 1,
        image: "/shoppingCart-block.dark-1.png",
        demoUrl: "/demos/shopping-cart-1",
        code: `
      <div class='bg-white'>
                ...
                <div class="md:col-span-2 bg-gray-100 p-4 rounded-md">
                    ...
                    <div class="space-y-4">
                        <div class="grid grid-cols-3 items-center gap-4">
                            <div class="col-span-2 flex items-center gap-4">
                                <div class="w-24 h-24 shrink-0 bg-white p-2 rounded-md">
                                    <img src='https://readymadeui.com/images/product14.webp' alt='image' class="w-full h-full object-contain" />
                                </div>
                        ...
                        <div class="grid grid-cols-3 items-center gap-4">
                            <div class="col-span-2 flex items-center gap-4">
                                <div class="w-24 h-24 shrink-0 bg-white p-2 rounded-md">
                                    <img src='https://readymadeui.com/images/watch5.webp' alt='image' class="w-full h-full object-contain" />
                                </div>
                        ...
                        <div class="grid grid-cols-3 items-center gap-4">
                            <div class="col-span-2 flex items-center gap-4">
                                <div class="w-24 h-24 shrink-0 bg-white p-2 rounded-md">
                                    <img src='https://readymadeui.com/images/sunglass1.webp' alt='image' class="w-full h-full object-contain" />
                                </div>
      ...
      {
        id: 2,
        image: "/shoppingCart-block.dark-2.png",
        demoUrl: "/demos/shopping-cart-2",
        code: `
      <div class="bg-white">
      ...
      {
        id: 3,
        image: "/shoppingCart-block.dark-3.png",
        demoUrl: "/demos/shopping-cart-3",
        code: `
       <div class="bg-white">
      ...
      {
        id: 4,
        image: "/shoppingCart-block.dark-4.png",
        demoUrl: "/demos/shopping-cart-4",
        code: `
       <div class="bg-white">
        <div class="font-sans">
              ...
              <div class="grid md:grid-cols-4 items-center gap-4 py-4">
                <div class="col-span-2 flex items-center gap-6">
                  ...
                  <div>
                    ...
                    <h6 class="text-sm text-gray-500 mt-1">
                      Color:{" "}
                      <span class="ml-2 font-semibold">Black/White</span>
                    </h6>
                  </div>
                </div>
                ...
                <div class="flex items-center">
                  <h4 class="text-base font-bold text-gray-800">$24.00</h4>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    class="w-3 cursor-pointer shrink-0 fill-gray-400 hover:fill-red-500 ml-auto"
                    viewBox="0 0 320.591 320.591"
              ...
              <div class="grid md:grid-cols-4 items-center gap-4 py-4">
                <div class="col-span-2 flex items-center gap-6">
                  ...
                  <div>
                    ...
                    <h6 class="text-sm text-gray-500 mt-1">
                      Color: <span class="ml-2 font-semibold">Gray</span>
                    </h6>
                  </div>
                </div>
                ...
                <div class="flex items-center">
                  <h4 class="text-base font-bold text-gray-800">$22.00</h4>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    class="w-3 cursor-pointer shrink-0 fill-gray-400 hover:fill-red-500 ml-auto"
                    viewBox="0 0 320.591 320.591"
            ...
            <div class="bg-gradient-to-tl from-[#B0EBB4] via-[#BFF6C3] to-[#E0FBE2] p-6 lg:sticky top-0">
              <ul class="text-gray-800 divide-y divide-gray-300">
                <li class="flex flex-wrap gap-4 text-sm pb-4 font-semibold">
                  Subtotal <span class="ml-auto">$46.00</span>
                </li>
                <li class="flex flex-wrap gap-4 text-sm py-4 font-semibold">
                  Shipping <span class="ml-auto">$4.00</span>
                </li>
                <li class="flex flex-wrap gap-4 text-sm py-4 font-semibold">
                  Tax <span class="ml-auto">$4.00</span>
                </li>
      ...
      {
        id: 5,
        image: "/shoppingCart-block.dark-5.png",
        demoUrl: "/demos/shopping-cart-5",
        code: `
      <div class="bg-white">
      ...
      {
        id: 6,
        image: "/shoppingCart-block.dark-6.png",
        demoUrl: "/demos/shopping-cart-6",
        code: `
      <div class="bg-white">
      ...
      {
        id: 7,
        image: "/shoppingCart-block.dark-7.png",
        demoUrl: "/demos/shopping-cart-7",
        code: `
      <div class="bg-white">
        <div class="font-[sans-serif] bg-white h-full">
          <div class="max-w-7xl max-lg:max-w-3xl mx-auto p-6">
            ...
            <div class="grid lg:grid-cols-3 gap-6 relative mt-8">
              <div class="lg:col-span-2 space-y-6">
                <div class="p-2 bg-white shadow-[0_3px_20px_-10px_rgba(6,81,237,0.4)] rounded-md relative">
                  <div class="grid sm:grid-cols-2 items-center gap-4">
                    <div class="bg-gradient-to-tr from-gray-300 via-gray-100 rounded-md to-gray-50 w-full h-full p-4 shrink-0 text-center">
                      <img
                        src="https://readymadeui.com/images/product10.webp"
                        class="w-56 h-full object-contain inline-block"
                      />
                    </div>
                    ...
                    <div class="p-2">
                      ...
                      <div class="flex items-center justify-between flex-wrap gap-4 mt-6">
                        <div class="flex items-center gap-3">
                          <h4 class="text-sm text-gray-500">Qty:</h4>
                          <button
                            type="button"
                            class="flex items-center justify-center w-5 h-5 bg-blue-600 outline-none rounded-full"
                          >
                      ...
                      <div class="divide-x border-y grid grid-cols-2 text-center mt-6">
                        <button
                          type="button"
              ...
              <div class="bg-white h-max rounded-md p-4 shadow-[0_3px_20px_-10px_rgba(6,81,237,0.4)] sticky top-0">
                <h3 class="text-lg font-bold text-gray-800">
                  Order Summary
                </h3>

                <ul class="text-gray-500 text-sm space-y-3 mt-3">
                  <li class="flex flex-wrap gap-4">
                    Subtotal <span class="ml-auto font-bold">$70.00</span>
                  </li>
                  <li class="flex flex-wrap gap-4">
                  ...
                  <li class="flex flex-wrap gap-4 font-bold">
                    Total <span class="ml-auto">$74.00</span>
                  </li>
                </ul>

                <button
                  type="button"
                  class="mt-6 text-sm px-6 py-3 w-full bg-blue-700 hover:bg-blue-800 tracking-wide text-white rounded-md"
                >
                  Make Payment
                </button>
      ...
      {
        id: 8,
        image: "/shoppingCart-block.dark-8.png",
        demoUrl: "/demos/shopping-cart-8",
        code: `
       <div class="bg-white">
